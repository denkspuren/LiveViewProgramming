...
public class Interaction {
    ...
    public static String button(String text, int width, int height, String onClick) {
        return TextUtils.fillOut("<button style='width: ${0}px; height: ${1}px;' onclick='${2}'>${3}</button>", width, height, onClick, text);
    }

    public static String button(String text, String onClick) {
        return TextUtils.fillOut("<button style='padding: 2px 15px;' onclick='${0}'>${1}</button>", onClick, text);
    }
    ...
    public static String input(Path path, String label, String template, String placeholder, String type) {
        ...
        String inputField = TextUtils.fillOut("""
        ...
        String button = button("Send", TextUtils.fillOut("""
            (() => {
